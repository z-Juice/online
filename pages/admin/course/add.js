                ...
                <Row>
                  <Col span={6}>
                    <FormItem
                      ...
                      {...formItemLayout1}
                      label="禁用课程">
                      {getFieldDecorator('status', { valuePropName: 'checked', initialValue: false })(
                  ...
                  <Col span={6}>
                    <FormItem
                      ...
                      {...formItemLayout1}
                      label="精品课程">
                      {getFieldDecorator('is_top', { valuePropName: 'checked', initialValue: true })(
                        <Switch checkedChildren="开" unCheckedChildren="关" />
                      )}
                    </FormItem>
                  </Col>
                  <Col span={6}>
                    <FormItem
                      ...
                      label="热门课程">
                      {getFieldDecorator('is_hot', { valuePropName: 'checked', initialValue: true })(
                        <Switch checkedChildren="开" unCheckedChildren="关" />
                      )}
                    </FormItem>
                  </Col>
                  <Col span={6}>
                    <FormItem
                      ...
                      label="轮播课程">
                      {getFieldDecorator('is_slide', { valuePropName: 'checked', initialValue: true })(
                        <Switch checkedChildren="开" unCheckedChildren="关" />
                      )}
                    </FormItem>
                  </Col>
